...
const TherapistCard = ({ therapist, onEdit }) => {
  ...
  return (
    <div className="bg-gray-900/80 backdrop-blur-sm border border-primary-500 rounded-2xl shadow-lg hover:shadow-primary-800/50 transition-all duration-300 overflow-hidden relative group p-6">
      {/* Header: Icon + Info */}
      <div
      ...
      >
        {/* Icon */}
        <div className="bg-gradient-to-br from-primary-700 to-primary-900 p-4 rounded-full shadow-lg">
        ...
        <div className="flex-1">
          ...
          <div className="h-0.5 bg-primary-600 to-transparent my-1 w-[90%]"></div>
      ...
      <div className="bg-gray-700 bg-opacity-40 p-4 rounded-lg my-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="overflow-hidden">
            <div className="flex items-center space-x-2 mb-1">
              <FaHospital className="text-primary-400 flex-shrink-0" />
          ...
          <div>
            ...
            <span className="text-primary-300 font-semibold">{therapist.consultationCount}</span>
          </div>
          ...
          <div>
            ...
            <span className="text-primary-300 italic">{therapist.experience} years</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-between items-center gap-4">
        ...
        <button
          ...
          className="flex items-center px-4 py-2 rounded-lg border border-primary-500 text-primary-400 hover:bg-primary-800 hover:text-white transition-all duration-200 shadow-sm"
        >
