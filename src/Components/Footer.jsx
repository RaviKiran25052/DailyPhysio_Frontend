    ...
    <footer className="bg-gray-900 border-t border-gray-800 pt-12 pb-8 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="/" className="text-gray-400 hover:text-purple-400">Mobility Training</a></li>
              <li><a href="/" className="text-gray-400 hover:text-purple-400">Strength Building</a></li>
              <li><a href="/" className="text-gray-400 hover:text-purple-400">Post-Surgery Recovery</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="/" className="text-gray-400 hover:text-purple-400">Our Experts</a></li>
          ...
          <div>
            ...
            <form className="flex flex-col space-y-2">
              <input 
                ...
                className="bg-gray-800 border border-gray-700 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
              />
              <button 
                type="submit" 
                className="bg-purple-600 hover:bg-purple-700 transition text-white rounded-md px-4 py-2 font-medium"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="pt-8 mt-8 border-t border-gray-800 text-sm text-center text-gray-400">
          <p className="mb-2">© 2025 ExerciseMD. All rights reserved.</p>
