...
const TherapistDashboard = () => {
	...
	const testimonials = [
		{
			quote: "ExerciseMD has completely transformed how I manage my patients' rehabilitation programs. The platform is intuitive and my patients love the guided exercises.",
			author: "Dr. Sarah Johnson, PT",
			role: "Physical Therapist"
		},
		{
			quote: "The exercise library is extensive and the ability to customize routines for each patient has made my practice much more efficient and effective.",
	...
	return (
		<div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
					...
					<div className="flex flex-col md:flex-row items-center">
						<div className="md:w-1/2 mb-8 md:mb-0">
							...
							<p className="text-xl text-gray-300 mb-8">
								The all-in-one platform for managing patient exercises, consultations, and rehabilitation progress.
							</p>
							<div className="flex flex-col sm:flex-row gap-4">
								<button
									onClick={() => setShowRegisterModal(true)}
									className="px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg font-medium hover:opacity-90 transition-all duration-200"
								>
									Get Started
								</button>
								<button
						...
						<div className="md:w-1/2">
							<div className="relative overflow-hidden">
								...
								<div className="absolute -bottom-8 right-0 w-72 h-72 bg-pink-500 rounded-full mix-blend-multiply filter blur-2xl opacity-30 animate-blob animation-delay-2000"></div>
			...
			<section className="py-16 px-4 bg-gray-800 bg-opacity-50">
				<div className="container mx-auto max-w-6xl">
					<h2 className="text-3xl font-bold text-center mb-12">Powerful Tools for Rehabilitation Professionals</h2>
			...
			<section className="py-16 px-4">
				<div className="container mx-auto max-w-6xl">
					<h2 className="text-3xl font-bold text-center mb-12">How ExerciseMD Works</h2>
			...
			<section className="py-16 px-4 bg-gray-800 bg-opacity-50">
				<div className="container mx-auto max-w-6xl">
					<h2 className="text-3xl font-bold text-center mb-12">What Therapists Are Saying</h2>
			...
			<section className="py-16 px-4">
				<div className="container mx-auto max-w-6xl">
					<h2 className="text-3xl font-bold text-center mb-4">Membership Plans</h2>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						{membershipPlans.map((plan, index) => (
							<div
								key={index}
								className={`bg-gray-800 rounded-xl overflow-hidden ${plan.featured
										? 'border-2 border-purple-500 transform scale-105 shadow-xl shadow-purple-500/20'
							...
							>
								...
								<div className="p-6">
									...
									<button
										className={`w-full py-3 rounded-lg font-medium transition-all duration-200 ${plan.featured
			...
			{/* CTA Section */}
			<section className="py-16 px-4 bg-gradient-to-r from-purple-700 to-pink-700">
				<div className="container mx-auto max-w-4xl text-center">
					<h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Your Practice?</h2>
					<p className="text-xl mb-8 text-gray-200">Join thousands of therapists who are improving patient outcomes with ExerciseMD.</p>
					<div className="flex flex-col sm:flex-row gap-4 justify-center">
						<button
							onClick={() => setShowRegisterModal(true)}
							className="px-8 py-3 bg-white text-purple-700 rounded-lg font-medium hover:bg-gray-100 transition-all duration-200"
						>
							Create Account
						</button>
						<button
							className="px-8 py-3 bg-transparent border-2 border-white rounded-lg font-medium hover:bg-white/10 transition-all duration-200"
						>
							Schedule Demo
						</button>
					</div>
