...
const AccountNotActivatedModal = ({ onLgin, onClose }) => {
		...
		<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
			<div className="bg-gray-900 rounded-lg p-6 max-w-lg w-full shadow-xl border-2 border-purple-500">
				<div className="flex flex-col items-center">
					...
					<h2 className="text-2xl font-semibold text-white mb-2">Account Not Activated</h2>

					<p className="text-gray-600 text-center m-6 mt-0">
						Your therapist account has not been activated by an administrator yet.
						Please wait for approval or contact support for assistance.
					</p>

					<div className="flex flex-col sm:flex-row gap-3 w-full justify-center">
						<button
							onClick={onLgin}
							className="py-2 px-4 bg-purple-700 hover:bg-purple-900 text-white font-medium rounded-md transition-colors"
						>
...
export default AccountNotActivatedModal;