	...
	return (
		<div className="flex flex-col items-center justify-center h-96 bg-gray-800 rounded-lg p-8 text-center">
			...
			{buttonText && onClick && (
				<button
					onClick={onClick}
					className="px-6 py-3 bg-primary-600 rounded-md hover:bg-primary-700 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 focus:ring-offset-gray-800 text-white font-medium"
				>
					{buttonText}
				</button>
			)}
