      ...
      <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
        ...
        <form onSubmit={onSubmit} className="w-full md:w-auto flex-grow md:max-w-md">
          <div className="relative flex items-center">
            <input
              ...
              className="w-full py-2 px-4 pr-10 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
            />
            <button
              type="submit"
        ...
        <div className="flex space-x-1 bg-gray-700 rounded-md p-1">
          <button
            ...
            className={`p-1 rounded ${layoutSize === 'small' ? 'bg-primary-700' : 'hover:bg-gray-600'}`}
            title="Small"
          >
            <Grid size={16} />
          </button>
          <button
            ...
            className={`p-1 rounded ${layoutSize === 'medium' ? 'bg-primary-700' : 'hover:bg-gray-600'}`}
            title="Medium"
          >
            <Grid size={18} />
          </button>
          <button
            ...
            className={`p-1 rounded ${layoutSize === 'large' ? 'bg-primary-700' : 'hover:bg-gray-600'}`}
            title="Large"
          >
            <Grid size={20} />
          </button>
